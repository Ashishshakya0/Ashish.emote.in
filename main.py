...
<body>
    ...
    <script>
        ...
        // Send Basic emote
        function sendBasicEmote(emoteId, emoteName) {
            const team = document.getElementById('basic_team').value;
            const target = document.getElementById('basic_target').value;
        ...
        function sendCommand(team, emote, target, emoteName = '') {
            showNotification('📤 Sending command to Termux bot...', 'success');
