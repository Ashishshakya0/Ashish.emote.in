...
import requests  # Web panel के लिए
...
# BotManager class के बाद:
async def check_web_panel_commands():
    """Web panel से commands check करे"""
    try:
        if os.path.exists(COMMANDS_FILE):
            ...
            if content:
                print(f"🌐 Web Panel Command: {content}")
                # Command process करे
                # ...
